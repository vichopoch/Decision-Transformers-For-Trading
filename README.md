...
### Quickstart
Use `make download` to fetch IPSA data and `make train` to run a small training. The `deploy` script generates daily orders. Invoke `make mutate N=5` to run evolutionary improvements.
